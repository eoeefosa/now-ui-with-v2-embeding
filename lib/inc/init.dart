...
Size screenSize(FlutterView window) {
...
Widget _getDrawerListTile({required String image, required String semanticLabel, required String title, required Function onTap}) {
  ...
  return ListTile(
      ...
      leading: Padding(
        ...
        child: Image.asset(imagesPath + image, semanticLabel: semanticLabel, width: _perfixDrawerIconsSize, fit: BoxFit.cover),
      ),
      title: Text(title, style: TextStyle(color: _drawerTitlesColor, fontSize: _drawerTitlesSize, fontWeight: FontWeight.bold, letterSpacing: 1.0)),
              ...
              child: Column(children: <Widget>[
                Expanded(
                  ...
                  Container(
                      decoration: BoxDecoration(
                          gradient: LinearGradient(
                              colors: <Color>[Color.fromRGBO(0, 0, 0, .9), appMainColor],
                  ...
                  Container(
                      ...
                      decoration: BoxDecoration(image: DecorationImage(image: AssetImage(imagesPath + "drawer-background.png"), fit: BoxFit.cover))),
                  //Content
                  Container(
                      child: Column(children: <Widget>[
                    //Pages
                        ...
                        child: Padding(
                            ...
                            child: ListView(physics: NeverScrollableScrollPhysics(), children: <Widget>[
                              _getDrawerListTile(
                                ...
                                title: "NEWS",
                                onTap: () => Navigator.popAndPushNamed(context, "/Discover"),
                              ),
                              _getDrawerListTile(
                                image: "channels.png",
                                semanticLabel: "Channels Icon",
                                title: "CHANNELS",
                                onTap: () => Navigator.popAndPushNamed(context, "/Channels"),
                              ),
                              _getDrawerListTile(
                                image: "bookmarks.png",
                                semanticLabel: "Bookmarks Icon",
                                title: "BOOKMARKS",
                                onTap: () => Navigator.popAndPushNamed(context, "/Bookmarks"),
                              ),
                              _getDrawerListTile(
                                image: "overview.png",
                                semanticLabel: "Overview Icon",
                                title: "OVERVIEW",
                                onTap: () => Navigator.popAndPushNamed(context, "/Overview"),
                              ),
                              _getDrawerListTile(
                                image: "calendar.png",
                                semanticLabel: "Calendar Icon",
                                title: "CALENDAR",
                                onTap: () => Navigator.popAndPushNamed(context, "/Calendar"),
                              ),
                              _getDrawerListTile(
                                image: "timeline.png",
                                semanticLabel: "Timeline Icon",
                                title: "TIMELINE",
                                onTap: () => Navigator.popAndPushNamed(context, "/Timeline"),
                              ),
                              _getDrawerListTile(
                                image: "profile.png",
                              ...
                              _getDrawerListTile(
                                ...
                                title: "WIDGETS",
                                onTap: () => Navigator.popAndPushNamed(context, "/Widgets"),
                              ),
                              _getDrawerListTile(
                                image: "settings.png",
                    ...
                    Container(
                        ...
                        decoration: BoxDecoration(border: Border(top: BorderSide(width: .2, color: Colors.white70))),
                        //Info
                        child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: <Widget>[
                          ...
                          Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.spaceBetween, children: <Widget>[
                            ...
                            GestureDetector(
                              ...
                              child: Text("LOG OUT", style: TextStyle(color: Colors.white, fontSize: 14.0, fontWeight: FontWeight.bold, letterSpacing: .5)),
                            ),
                            //Username
                            Padding(
                              ...
                              child: GestureDetector(
                                ...
                                child: Text("Khaled Mohsen", style: TextStyle(fontSize: 12.0, color: Colors.white70)),
                              ),
                            )
                          ]),
                          //User picture
                          Padding(
                              ...
                              child: GestureDetector(
                                ...
                                child:
                                    CircleAvatar(radius: 35.0, backgroundColor: Colors.transparent, child: Image.asset(imagesPath + "logo.png", width: 30.0)),
                              ))
                        ]))
                  ]))
                ]))
