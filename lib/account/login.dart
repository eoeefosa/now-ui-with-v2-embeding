    ...
    KeyboardVisibilityBuilder(
      builder: (p0, isKeyboardVisible) {
        if (!isKeyboardVisible && (isFocusedUsername || isFocusedPassword)) {
          setState(() {
            usernameFocus.hasFocus ? usernameFocus.unfocus() : passwordFocus.unfocus();
            ...
            child: Container(
              ...
              child: Column(children: <Widget>[
                ...
                _isKeyboard
                    ...
                    : Container(
                        height: screenSize(window).height / 2 - (statusBarHeight(context) / 2), //Test
                ...
                //Form
                Container(
                    height: screenSize(window).height / 2 - (statusBarHeight(context) / 2),
                    child: Form(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            prefixIcon: Padding(
                              ...
                              child: Image.asset(imagesPath + "username.png", scale: 1.8, semanticLabel: "Username Text Field, Icon (User)"),
                            ),
                          ),
                          ...
                          children: [
                            ElevatedButton(
                              style: ElevatedButton.styleFrom(
                                backgroundColor: Color.fromRGBO(255, 106, 58, 1.0),
                      ...
                      Container(
                        ...
                        child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: <Widget>[
                          TextButton(
                              ...
                              child: Text("Create Account", style: TextStyle(fontSize: 12.5, color: Colors.white54))),
                          TextButton(
                              onPressed: () => Navigator.popAndPushNamed(context, "/ForgetPassword"),
                              child: Text("Need Help?", style: TextStyle(fontSize: 12.5, color: Colors.white54)))
                        ]),
                      )
                    ])))
              ]),
