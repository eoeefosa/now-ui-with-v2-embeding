...
class _SettingsState extends State<Settings> {
  ...
  Widget _getSwitch({required String text, required int index}) {
    return Padding(
        padding: EdgeInsets.fromLTRB(25, .0, 25.0, 3.0),
        child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: <Widget>[
          Text(text, style: TextStyle(fontSize: 12.0, fontWeight: FontWeight.bold, letterSpacing: .3)),
          /*Platform.isAndroid
  ...
  void initState() {
    ...
    KeyboardVisibilityBuilder(builder: (context, isKeyboardVisible) {
      if (!isKeyboardVisible && (isFocusedUsername || isFocusedEmail || isFocusedPassword)) {
        setState(() {
            ...
            leading: Builder(
                builder: (context) => Tooltip(
                    ...
                    child: GestureDetector(
                        ...
                        onTap: () => Scaffold.of(context).openDrawer()))), //Menu
            title: Image.asset(imagesPath + "logo.png", scale: appBarIconScale), //Logo
            centerTitle: true,
            actions: <Widget>[
              Tooltip(
                  message: "Logout",
                  child: GestureDetector(onTap: () => logout(context), child: Container(child: Image.asset(imagesPath + "logout.png", scale: appBarIconScale))))
            ],
            ...
            Container(
                ...
                child: Column(children: <Widget>[
                  Padding(
                    ...
                    child:
                        Text("settings".toUpperCase(), style: TextStyle(color: Colors.white, fontSize: 22.0, fontWeight: FontWeight.bold, letterSpacing: .3)),
                  ),
                  //Upload pic, Pic, Sync
                  Padding(
                      ...
                      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: <Widget>[
                        ...
                        GestureDetector(
                          ...
                          child: CircleAvatar(
                            child: Image.asset(imagesPath + "upload.png", width: 25.0),
                            radius: 28.0,
                            backgroundColor: Colors.white12,
                          ),
                        ),
                        //User pic
                        CircleAvatar(child: Image.asset(imagesPath + "logo.png", width: 38.0), radius: 28.0, backgroundColor: Colors.transparent),
                        //Sync
                        GestureDetector(
                          onTap: () => print("Sync pressed"),
                          child: CircleAvatar(
                            child: Image.asset(imagesPath + "sync.png", width: 25.0),
                            radius: 28.0,
                            backgroundColor: Colors.white12,
                          ),
                        )
                  ...
                  Container(
                      child: Form(
                          child: Column(mainAxisAlignment: _isKeyboard ? MainAxisAlignment.end : MainAxisAlignment.center, children: <Widget>[
                    //Username
                    Container(
                        margin: EdgeInsets.fromLTRB(25.0, .0, 25.0, 15.0),
                        decoration: BoxDecoration(color: Colors.white12, borderRadius: BorderRadius.circular(35.0)),
                        child: TextFormField(
                            ...
                            decoration: InputDecoration(
                                ...
                                prefixIcon: Padding(
                                    ...
                                    child: Container(
                                      child: Image.asset(imagesPath + "name.png", scale: 1.8, width: 47.0, semanticLabel: "Username Text Field, Icon (Name)"),
                                    ))),
                        ...
                        child: TextFormField(
                            ...
                            decoration: InputDecoration(
                                ...
                                prefixIcon: Padding(
                                  ...
                                  child: Image.asset(imagesPath + "email.png", scale: 1.8, semanticLabel: "EMail Text Field, Icon (EMail)"),
                                )),
                            style: TextStyle(color: Colors.white))),
                    //Password
                    Container(
                        ...
                        child: TextFormField(
                            ...
                            decoration: InputDecoration(
                                ...
                                prefixIcon: Padding(
                                  ...
                                  child: Image.asset(imagesPath + "password.png", scale: 1.8, semanticLabel: "Password Text Field, Icon (Lock)"),
                                )),
                            style: TextStyle(color: Colors.white)))
                  ])))
                ])),
            ...
            Container(
              ...
              Padding(
                  ...
                  child: Text("email notifications".toUpperCase(),
                      style: TextStyle(fontSize: 12.0, fontWeight: FontWeight.bold, letterSpacing: .5, color: appMainColor))),
              //Friday
