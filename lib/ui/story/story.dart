...
class _StoryState extends State<Story> with SingleTickerProviderStateMixin {
  ...
  Widget _getIntro({required String intro}) {
    return Container(
  ...
  Widget _getQuote({required String qoute, required String source}) {
    return Container(
  ...
  Widget _getQuestion({required String question}) {
    return Container(
  ...
  Widget _getParagraph({required String paragraph}) {
    return Container(
